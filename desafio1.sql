...
CREATE TABLE SpotifyClone.usuario_musica(
    ...
    CONSTRAINT PRIMARY KEY (usuario_id, musica_id, data_reproducao)
) engine = InnoDB;
...
INSERT INTO SpotifyClone.albuns (titulo, ano, artista_id)
VALUES
  ('Envious', '1990', '1'),
  ('Exuberant', '1993', '1'),
...
INSERT INTO SpotifyClone.musicas (titulo, duracao_segundos, album_id, artista_id)
VALUES
  ('Soul For Us', '200', '1', '1'),
...
INSERT INTO SpotifyClone.usuario_musica (usuario_id, musica_id, data_reproducao)
VALUES
